# -*- coding: utf-8 -*-
"""the one with existed Data.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1breBXXeuaHSQFwtieFgxF9A2lO6pr9Pl
"""
...
class AIModel:
    def generateExamSchedule(startDate, endDate):
        ...
        def schedule_11151(course_id, sections, students):
            ...
            for time in required_times:
                for room_no, capacity in total_rooms:
                    ...
                    # Check if time slot is not overbooked
                #  if len(exam_slots[(date_str, time)]) >= 8:
                #     print(f" Time slot {time} on {date_str} already has 8 exams.")
                    #    return
        ...
        # Now schedule all other courses, skipping "11151"
